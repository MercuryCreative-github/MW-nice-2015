...
<form name="editgroup" id="post" method="post" action="admin.php?page=adrotate-groups">
	...
	<h3><?php _e('Advanced', 'adrotate'); ?></h3>
   	<table class="widefat" style="margin-top: .5em">
	    <tr>
			...
			<td>
				<label for="adrotate_admargin_top">Top: <input tabindex="9" name="adrotate_admargin_top" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin; ?>" autocomplete="off" /> Bottom: <input tabindex="9" name="adrotate_admargin_bottom" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_bottom; ?>" autocomplete="off" /> <?php _e('pixel(s)', 'adrotate'); ?>.<br />Left: <input tabindex="10" name="adrotate_admargin_left" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_left; ?>" autocomplete="off" /> Right: <input tabindex="11" name="adrotate_admargin_right" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_right; ?>" autocomplete="off" /> <?php _e('pixel(s)', 'adrotate'); ?>.</label>
			</td>
			<td colspan="2">
		        <p><em><?php _e('A transparent area outside the advert in pixels. Default: 0/0/0/0.', 'adrotate'); ?> <?php _e('Set to 0 to disable.', 'adrotate'); ?></em></p>
			</td>
		</tr>
	    <tr>
	    ...
	    <tr>
			...
			<td>
				...
				<select tabindex="13" name="adrotate_fallback">
      	...
      	<tr>
	        ...
	        <td><label for="adrotate_sortorder"><input tabindex="14" name="adrotate_sortorder" type="text" size="5" class="search-input" autocomplete="off" value="<?php echo $edit_group->sortorder;?>" /></label></td>
   	...
   	<table class="widefat" style="margin-top: .5em">
      	<tr>
	        ...
	        <label for="adrotate_cat_location">
		        <select tabindex="15" name="adrotate_cat_location">
	        ...
	        <label for="adrotate_cat_paragraph">
		        <select tabindex="16" name="adrotate_cat_paragraph">
      	...
      	<tr>
	        ...
	        <label for="adrotate_page_location">
		        <select tabindex="17" name="adrotate_page_location">
	        ...
	        <label for="adrotate_page_paragraph">
		        <select tabindex="18" name="adrotate_page_paragraph">
	...
	<p class="submit">
   	...
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td colspan="2"><textarea tabindex="20" name="adrotate_wrapper_before" cols="65" rows="3"><?php echo stripslashes($edit_group->wrapper_before); ?></textarea></td>
			<td width="35%">
	    ...
	    <tr>
			...
			<td colspan="2"><textarea tabindex="21" name="adrotate_wrapper_after" cols="65" rows="3"><?php echo stripslashes($edit_group->wrapper_after); ?></textarea></td>
			<td>
	...
	<p class="submit">
		<input tabindex="22" type="submit" name="adrotate_group_submit" class="button-primary" value="<?php _e('Save Group', 'adrotate'); ?>" />
		<a href="admin.php?page=adrotate-groups&view=manage" class="button"><?php _e('Cancel', 'adrotate'); ?></a>
	</p>
