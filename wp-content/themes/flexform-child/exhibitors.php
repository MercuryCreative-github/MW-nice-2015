...
<div class="inner-page-wrap <?php echo $page_wrap_class; ?> clearfix">
    ...
    <script id="speakersTemplate" type="text/x-jQuery-tmpl">
		...
		<li style="list-style:none;"><!--a href="#speaker-${Id}" style="text-align:center;"><img alt="" src="${ImageUrl}" width="100%"></a>
		<a href="#speaker-${Id}" style="text-align:center; margin-top:10px;">${Name}</a-->

		<a href="#speaker-${Id}" style="text-align:center;" title="${Name}" alt="${Name}">
		<img title="${Name}" alt="${Name}" src="{{if ImageUrl==''}} http://www.tmforumlive.org/wp-content/uploads/2014/01/caja.png
		{{else}}${ImageUrl}{{/if}}" width="60%" style="width: 60%;">
		</a>

		<p style="text-align:center; margin-top:10px;position: absolute; top:145px;width: 100%;">${Name}</p>
