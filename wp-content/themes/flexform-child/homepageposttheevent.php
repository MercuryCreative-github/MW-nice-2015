<?php
/*
Template Name: Home Page Post the Event
*/
?>
<?php get_header(); ?>
...
<style type="text/css">
	.page-template-homepageposttheevent-php #main-container .container{
	    margin: 0;
	    padding: 0;
	    width: 100%!important;
    }	.page-template-homepageposttheevent-php #main-container section{
	    display: table;  width:100%;
    }
    }.page-template-homepageposttheevent-php #main-container section>div.cell{
	    display: table-cell;
