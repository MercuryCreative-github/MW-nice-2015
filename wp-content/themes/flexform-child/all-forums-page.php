<?php
/*
Template Name: All Summits Page
*/
?>
<?php get_header(); ?>
		...
		<div class="page-content clearfix">
			...
			function callLoop($forumId){
				...
				$forum.='<div forum="'.$forumToShow.'" class="textTrack'.$i.' moveDiv" day="' . $daytag . '" time="' .$time. '" hour="' .$hour. '" mins="' .$mins. '"><div class="body-text clearfix">
									<h2><a href="'.$linkToForum.'">'.$forumToShow.' - '.get_the_title().'</a></h2>
									<div class="timeTrack">' .$daytag.  $displayTime . $subtitle. '</div>' . $speakersDisplay.$moderatorsDisplay.$panelistsDisplay.$collaboratorDisplay.'<div class="link-pages"></div>
								</div></div>';
			$i++;
			endwhile;
			echo $forum;
